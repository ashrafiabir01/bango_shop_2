...
class Catagory_Electronics extends StatefulWidget {
  const Catagory_Electronics({Key? key}) : super(key: key);

  @override
  _Catagory_ElectronicsState createState() => _Catagory_ElectronicsState();
}

class _Catagory_ElectronicsState extends State<Catagory_Electronics> {

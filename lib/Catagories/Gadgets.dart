...
class Catagory_Gadgets extends StatefulWidget {
  const Catagory_Gadgets({Key? key}) : super(key: key);

  @override
  _Catagory_GadgetsState createState() => _Catagory_GadgetsState();
}

class _Catagory_GadgetsState extends State<Catagory_Gadgets> {

...
class Catagory_Global extends StatefulWidget {
  const Catagory_Global({Key? key}) : super(key: key);

  @override
  _Catagory_GlobalState createState() => _Catagory_GlobalState();
}

class _Catagory_GlobalState extends State<Catagory_Global> {
